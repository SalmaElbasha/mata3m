...
import 'package:ra7alah/screens/HomeScreen/home_controller.dart';
import 'package:ra7alah/screens/HomeScreen/widget/home_cell.dart';
        ...
        return controller.loading? LoadingWidget():Center(
            child: ListView.builder(
              ...
              itemBuilder:
                ...
                return  HomeCell(title: controller.govList[index].gov, subTitle: arrOfLoc[index],location: controller.govList[index],);
              },
            ));},
      ) ,
    );
